...
/**
 * Generated class for the VideopurchasePage page.
 *
...
@Component({
  selector: 'page-videopurchase',
  templateUrl: 'videopurchase.html',
})
export class VideopurchasePage {
  userid;
  ...
  openhome(){
    ...
    item['id']='0';
    item['url']='0';
    this.navCtrl.push('EbooksPage', { item: item,Secitem: '4' });
  }
  datacountlist;
  tabslisting(refresher?) {
    let url = 'https://app.ibpsguide.com/api/purchase_userproducts.php?day='+this.day+'&type=4&catg='+this.sub_id+'&userid='+this.userid;
